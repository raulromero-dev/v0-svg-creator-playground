...
export function HowItWorksModal({ open, onOpenChange }: HowItWorksModalProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl bg-[#141414] border border-[#2A2A2A] text-gray-200">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-white">How it works</DialogTitle>
        </DialogHeader>
        <div className="space-y-6 text-sm text-gray-400 max-h-[60vh] overflow-y-auto pr-2">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">About SVG Creator</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">Text-to-SVG Generation</h3>
            <p className="leading-relaxed">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">Image-to-SVG Conversion</h3>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>
                <kbd className="px-1.5 py-0.5 bg-white/10 rounded text-xs">⌘/Ctrl + Enter</kbd> - Generate SVG
              </li>
              <li>
                <kbd className="px-1.5 py-0.5 bg-white/10 rounded text-xs">⌘/Ctrl + C</kbd> - Copy SVG to clipboard
              </li>
              <li>
                <kbd className="px-1.5 py-0.5 bg-white/10 rounded text-xs">⌘/Ctrl + D</kbd> - Download SVG
              </li>
              <li>
                <kbd className="px-1.5 py-0.5 bg-white/10 rounded text-xs">⌘/Ctrl + U</kbd> - Load generated SVG as
                input
              </li>
              <li>
